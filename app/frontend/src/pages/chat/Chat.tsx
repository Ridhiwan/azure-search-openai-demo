    ...
    return (
        <div className={styles.container}>
            <div className={styles.commandsContainer}>
                ...
                {/* Uncomment the code below to enable the settings button */}
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <SparkleFilled fontSize={"120px"} primaryFill={"rgba(14, 174, 26, 1)"} aria-hidden="true" aria-label="Chat logo" />
                            <h1 className={styles.chatEmptyStateTitle}>Chat with TaxCap</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask anything about taxes or try an example</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What are the VAT regulations in Tanzania?)"
                            disabled={isLoading}
